    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Autocomplete2.default, _extends({}, this.props, {
          ...
          search: function search(t, input, selectedTags) {
            return _search(t, input, selectedTags);
          },
...
TagBoxContainer.defaultProps = {
  ...
  placeHolder: '',
  search: function search(tag, input, selected) {
    return tag.label.includes(input) && !selected.includes(tag);
  }
};
